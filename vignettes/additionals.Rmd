...
<img src = "./fig/plot-to-table.png" width  = "80%"> </img>
...
<img src = "./fig/select-to-bar.png" width  = "50%"> </img>
...
<img src = "./fig/bar-to-scatter01.png" width  = "50%"> </img>
<img src = "./fig/bar-to-scatter02.png" width  = "50%"> </img>
...
The assumption is that interactions that you attach will correspond to elements in the same
group (ie lies within the same SVG group element) such as a set of rectangles or a set of scatter points. These are generally expressed as a single
object in `grid` (via `listElements`).
